...
function register_popup(id, name)
{
    ...
    element +=  '<div style="clear: both"></div></div><div class="popup-messages" id="user-chat-realtime"><ul class="chat" style="margin:0px; padding:0px 5px;"></ul></div></div>';
    */
    var element = '<div class="popup-box chat-popup" id="'+ id +'">';
        element += '<div class="popup-head">';
                element += '<div class="popup-head-left">'+ name +'</div>';
                element += '<div class="popup-head-right">';
                    element += '<a href="javascript:close_popup(\''+ id +'\');">&#10005;</a>';
                element += '</div>';
                element += '<div style="clear: both"></div>';
            element += '</div>';
            element += '<div class="popup-messages" id="user-chat-realtime">';
                element += '<div class="panel-body msg_container_base">';

                    element += '<ul class="chat" style="margin:0px; padding:0px 5px;"></ul>';
                    element += '</br></br></br>';
...
function calculate_popups()
{
    ...
    {
        width = width - 270;
        //290 is width of a single popup box
        total_popups = parseInt(width/290);
    }
